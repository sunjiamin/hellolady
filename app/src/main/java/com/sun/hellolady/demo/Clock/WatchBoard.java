package com.sun.hellolady.demo.Clock;
...
/**
 * Created by sunjiamin on 2016/11/3.
 */
...
public class WatchBoard  extends View {
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mTextSize = array.getDimension(R.styleable.WatchBoard_wb_text_size, SptoPx(30));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mRadius = ((Math.min(w, h) - getPaddingLeft() - getPaddingRight()) / 2)-10;
    ...
    private float SptoPx(int value) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, value, getContext().getResources().getDisplayMetrics());
    }
