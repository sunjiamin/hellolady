...
public class ImActivity extends AppCompatActivity implements View.OnClickListener {
   // WebSocketClient socketClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ServerInfo[] serverInfos = {new ServerInfo("连接Java Web后台", "ws://120.25.161.238:9090/websocket")};// 所有连接后台
...
//
//        try {
//              URI uri = new URI("ws://120.24.38.136:90/websocket");
//              socketClient = new WebSocketClient(uri,new WebSocketClient.Listener(){
//
//                @Override
//                public void onConnect() {
//                    T.show(ImActivity.this,"Connect is Ok ");
//                }
//
//                @Override
//                public void onMessage(String message) {
//                    T.show(ImActivity.this,"onMessage: "+message);
//                }
//
//                @Override
...
//                    T.show(ImActivity.this,"onError: "+error.getMessage());
//                }
//            });
//
//
...
//                String ismi ="0000000001";// PhoneUtil.getPhoneIME(ImActivity.this);
//                socketClient.send("{\"comand\":\"login\",\"identity\":\"7a3517d809010157f831d22ad646bf0c  \",\"password\":\"7a3517d809010157f831d22ad646bf0c  \",\"type\":\"android\",\"deviceSerial\":\""+ismi+"\"}");
//
//            }
//        });
    }
...
//"ws://120.24.38.136:90/websocket";
            ...
            case R.id.btnSend:
                try {
                    if (client != null) {
                        String sun = PhoneUtil.getPhoneIME(ImActivity.this);
                        String msg="{\"comand\":\"login\",\"identity\":\"7a3517d809010157f831d22ad646bf0c\"," +
                                "\"password\":\"7a3517d809010157f831d22ad646bf0c\"," +
                                "\"type\":\"android\"," +
                                "\"deviceSerial\":\"000000001\"}";
                        client.send(msg);
