...
public class MyBehaviorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvBehavior.setLayoutManager(new LinearLayoutManager(MyBehaviorActivity.this));

        rvBehavior.setAdapter(new ItemAdapter());

    }

    private static class ItemAdapter extends RecyclerView.Adapter<MyBehaviorActivity.ItemViewHolder> {
        @Override
        public MyBehaviorActivity.ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return MyBehaviorActivity.ItemViewHolder.newInstance(parent);
        }

        @Override
        public void onBindViewHolder(final MyBehaviorActivity.ItemViewHolder holder, final int position) {
    ...
    private static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public static MyBehaviorActivity.ItemViewHolder newInstance(ViewGroup parent) {
            c =parent.getContext();
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_list_item, parent, false);
            return new MyBehaviorActivity.ItemViewHolder(view);
        }
